classdef validate_sim_results < matlab.unittest.TestCase
    ...
    methods(Test)
        function validateSimResults(testCase)
            ...
            simFile = load(dataPath)   %'simdata.mat';
            ...
            sprintf('%s: Cross-track error too large', courseName));

            testCase.verifyLessThanOrEqual( ...
            max_v_err, thresholds.max_verr, ...
            sprintf('%s: Velocity tracking error too large', courseName));

            testCase.verifyLessThanOrEqual( ...
            max_j_long, thresholds.max_jerk, ...
            sprintf('%s: Longitudinal jerk too high', courseName));

            testCase.verifyLessThanOrEqual( ...
            max_a_lat, thresholds.max_alat, ...
            sprintf('%s: Lateral acceleration too high', courseName));
